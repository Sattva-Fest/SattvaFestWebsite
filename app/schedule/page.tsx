const SchedulePage = () => {
    return (
        <>
            ...
            <div className="center bg-lavender mx-auto max-w-8xl space-y-16 py-16 px-8 md:space-y-32 md:py-32 md:px-20">
                <h1 className="text-h1-mobile md:mb-8 md:text-d1-mobile xl:text-d1">Day 1</h1>
                <iframe
                    ...
                    width="100%" height="1000px" className="border-0 rounded-md no-scrollbar">
                </iframe>
            </div>
        </>
    );
